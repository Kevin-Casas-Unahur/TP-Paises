...
class PaisesTest: DescribeSpec ({
    ...
    val brasil = Pais("Brasil", "BRA", 212600000, 8516000.0, "America", "BRL", 5.40)

    val uruguay = Pais("Uruguay", "URY", 3474000, 176215.0, "America", "UYU", 41.09)

    val bolivia = Pais("Bolivia", "BOL", 11670000, 1099000.0, "America", "BOB", 6.88)
    ...
    describe("Codigo alfa 3"){
        argentina.codigoAlfa3.shouldBe("ARG")
        bolivia.codigoAlfa3.shouldBe("BOL")
        uruguay.codigoAlfa3.shouldBe("URY")
    }

    describe("codigo moneda local"){
        argentina.codigoMonedaLocal.shouldBe("ARG")
        bolivia.codigoMonedaLocal.shouldBe("BOL")
        uruguay.codigoMonedaLocal.shouldBe("URY")
    }

    describe("densidad poblacional"){
        argentina.densidadPoblacional().shouldBe(16)
        bolivia.densidadPoblacional().shouldBe(10)
        uruguay.densidadPoblacional().shouldBe(19)
